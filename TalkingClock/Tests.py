...
from TalkingClock.Solution import IncorrectTimeFormatException, check_time_format, convert_to_json, make_clock_talk, \
    extract_time
...
class MakeClockTalkTest(unittest.TestCase):
    ...
    @mock.patch('Solution.extract_time')
    ...
    @mock.patch('Solution.convert_to_json')
    @mock.patch('Solution.extract_time')
